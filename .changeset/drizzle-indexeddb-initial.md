...
Initial release of `@firtoz/drizzle-indexeddb` - TanStack DB collections backed by IndexedDB with automatic migrations powered by Drizzle ORM snapshots.
...
// React integration
import { DrizzleIndexedDBProvider, useDrizzleIndexedDB } from "@firtoz/drizzle-indexeddb";
